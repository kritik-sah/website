...
const Navbar = () => {
    ...
    return (
        <>
        <nav className="navbar py-4 sticky shadow-md bg-white text-gray-600">
                ...
                <div className="flex items-center">
                    ...
                    <div className="dropdown dropdown-end">
                        <div tabIndex="0" className="btn btn-ghost rounded-btn">
                            GET STARTED
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400 hover:text-blue-900" viewBox="0 0 20 20" fill="currentColor">
